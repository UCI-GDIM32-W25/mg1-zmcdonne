...
For the MG1, I broke it down into steps, which I commented directly into the code and then incremented on. My plan wasn’t that different from Professor Reid’s example. In the Start method, I made sure the game started correctly, with the seeds left being 5 and NumSeedsPlanted being 0.
